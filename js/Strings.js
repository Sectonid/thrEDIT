function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/project/antialias': 'Anti-Aliasing',
		...
		ru: {
			...
			'prompt/file/open': 'Все несохранённые изменения будут удалены. Продолжить?',
			'prompt/file/failedToOpenProject': 'Не удалось открыть сцену!',
			'prompt/file/export/noMeshSelected': 'Нет выбранной модельки!',
			'prompt/file/export/noObjectSelected': 'Нет выбранного объекта!',
			'prompt/script/remove': 'Вы уверены?',
			'prompt/history/clear': 'История изменений будет удалена. Продолжить?',
			'prompt/history/preserve': 'История будет сохранена при выходе из интерфейса.\nМожет нагрузить систему при работе с текстурами.',
			'prompt/history/forbid': 'Нельзя отменять/возвращать, когда играет сцена.',
			'prompt/rendering/realistic/unsupportedMaterial': 'Реалистичное освещение: работает лишь на MeshStandardMaterial и MeshPhysicalMaterial.',

			'command/AddObject': 'Добавить объект',
			'command/AddScript': 'Добавить сценарий',
			'command/MoveObject': 'Переместить объект',
			'command/MultiCmds': 'Несколько изменений',
			'command/RemoveObject': 'Удалить объект',
			'command/RemoveScript': 'Удалить сценарий',
			'command/SetColor': 'Изменить цвет',
			'command/SetGeometry': 'Изменить фигуру',
			'command/SetGeometryValue': 'Изменить значение фигуры',
			'command/SetMaterialColor': 'Изменить цвет материала',
			'command/SetMaterial': 'Изменить материал',
			'command/SetMaterialMap': 'Поставить текстуру материала',
			'command/SetMaterialRange': 'Поставить длительность (?) материала',
			'command/SetMaterialValue': 'Поставить значение материала',
			'command/SetMaterialVector': 'Поставить вектор материала',
			'command/SetPosition': 'Изменить позицию',
			'command/SetRotation': 'Изменить угол',
			'command/SetScale': 'Изменить размер',
			'command/SetScene': 'Изменить сцену',
			'command/SetScriptValue': 'Изменить значение сценария',
			'command/SetShadowValue': 'Изменить значение тени',
			'command/SetUuid': 'Изменить UUID',
			'command/SetValue': 'Изменить значение',

			'menubar/file': 'Файл',
			'menubar/file/new': 'Новый',
			'menubar/file/new/empty': 'Пустой',
			'menubar/file/new/Camera': 'Камеры',
			'menubar/file/new/Particles': 'Частицы',
			'menubar/file/new/Shaders': 'Шейдеры',
			'menubar/file/open': 'Открыть',
			'menubar/file/save': 'Сохранить',
			'menubar/file/import': 'Импортировать',
			'menubar/file/export': 'Экспортировать',

			'menubar/edit': 'Редактировать',
			'menubar/edit/undo': 'Отменить',
			'menubar/edit/redo': 'Вернуть',
			'menubar/edit/center': 'В центр',
			'menubar/edit/clone': 'Дублировать',
			'menubar/edit/delete': 'Удалить',

			'menubar/add': 'Добавить',
			'menubar/add/group': 'Сгруппировать',

			'menubar/add/mesh': 'Моделька',
			'menubar/add/mesh/plane': 'Поверхность',
			'menubar/add/mesh/box': 'Куб',
			'menubar/add/mesh/capsule': 'Капсула',
			'menubar/add/mesh/circle': 'Круг',
			'menubar/add/mesh/cylinder': 'Цилиндер',
			'menubar/add/mesh/ring': 'Кольцо',
			'menubar/add/mesh/sphere': 'Сфера',
			'menubar/add/mesh/dodecahedron': 'Додекахедрон',
			'menubar/add/mesh/icosahedron': 'Икозахедрон',
			'menubar/add/mesh/octahedron': 'Октахедрон',
			'menubar/add/mesh/tetrahedron': 'Тетрахедрон',
			'menubar/add/mesh/torus': 'Торус',
			'menubar/add/mesh/tube': 'Труба',
			'menubar/add/mesh/torusknot': 'TorusKnot',
			'menubar/add/mesh/lathe': 'Lathe',
			'menubar/add/mesh/sprite': 'Спрайт',

			'menubar/add/light': 'Освещение',
			'menubar/add/light/ambient': 'Пространственное',
			'menubar/add/light/directional': 'Прямое (Солнце)',
			'menubar/add/light/hemisphere': 'Hemisphere',
			'menubar/add/light/point': 'Лампа',
			'menubar/add/light/spot': 'Spot',

			'menubar/add/camera': 'Камера',
			'menubar/add/camera/perspective': 'Перспективная',
			'menubar/add/camera/orthographic': 'Ортографическая',

			'menubar/status/autosave': 'Автосохранения',

			'menubar/view': 'Вид',
			'menubar/view/fullscreen': 'На полный экран',
			'menubar/view/gridHelper': 'Клетка',
			'menubar/view/cameraHelpers': 'Камеры',
			'menubar/view/lightHelpers': 'Освещения',
			'menubar/view/skeletonHelpers': 'Арматура',

			'menubar/help': 'Справка',
			'menubar/help/source_code': 'Исходный код',
			'menubar/help/icons': 'Набор иконок',
			'menubar/help/about': 'О thrEDIT',
			'menubar/help/docs': 'Документация',

			'sidebar/animations': 'Анимации',
			'sidebar/animations/play': 'Играть',
			'sidebar/animations/stop': 'Остановить',
			'sidebar/animations/timescale': 'Скорость',

			'sidebar/properties': 'Свойства',
			'sidebar/scene/background': 'Фон',
			'sidebar/scene/environment': 'Пространство',
			'sidebar/scene/fog': 'Туман',

			'sidebar/properties/object': 'Объект',
			'sidebar/properties/geometry': 'Фигура',
			'sidebar/properties/material': 'Материал',
			'sidebar/properties/script': 'Сценарий',
			...
			'sidebar/object/rotation': 'Угол',
			'sidebar/object/scale': 'Размер',
			'sidebar/object/fov': 'Поле Зрения',
			'sidebar/object/left': 'Влево',
			'sidebar/object/right': 'Вправо',
			'sidebar/object/top': 'Вверх',
			'sidebar/object/bottom': 'Вниз',
			'sidebar/object/near': 'Начало',
			'sidebar/object/far': 'Конец',
			'sidebar/object/intensity': 'Интенсивность',
			'sidebar/object/color': 'Цвет',
			'sidebar/object/groundcolor': 'Цвет пола',
			'sidebar/object/distance': 'Дистанция',
			'sidebar/object/angle': 'Угол',
			'sidebar/object/penumbra': 'Penumbra',
			'sidebar/object/decay': 'Decay',
			'sidebar/object/shadow': 'Тень',
			'sidebar/object/shadowIntensity': 'Интенсивность тени',
			'sidebar/object/shadowBias': 'Bias тени',
			'sidebar/object/shadowNormalBias': 'Bias нормали тени',
			'sidebar/object/shadowRadius': 'Размытие тени',
			'sidebar/object/cast': 'Подавать',
			'sidebar/object/receive': 'Получать',
			'sidebar/object/visible': 'Видимый',
			'sidebar/object/frustumcull': 'Frustum Cull',
			'sidebar/object/renderorder': 'Порядок рендеринга',
			'sidebar/object/userdata': 'Пользовательские переменные',
			'sidebar/object/export': 'Экспортировать в виде JSON',

			'sidebar/geometry/type': 'Тип',
			'sidebar/geometry/new': 'Новый',
			'sidebar/geometry/uuid': 'UUID',
			'sidebar/geometry/name': 'Имя',
			'sidebar/geometry/bounds': 'Края',
			'sidebar/geometry/userdata': 'Пользовательские переменные',
			'sidebar/geometry/show_vertex_normals': 'Показывать нормали вершин',
			'sidebar/geometry/compute_vertex_normals': 'Вычислить нормали вершин',
			'sidebar/geometry/compute_vertex_tangents': 'Вычислить Tangents',
			'sidebar/geometry/center': 'Центр',
			'sidebar/geometry/export': 'Экспортировать в виде JSON',

			'sidebar/geometry/box_geometry/width': 'Ширина',
			'sidebar/geometry/box_geometry/height': 'Высота',
			'sidebar/geometry/box_geometry/depth': 'Длина',
			'sidebar/geometry/box_geometry/widthseg': 'Сегменты ширины',
			'sidebar/geometry/box_geometry/heightseg': 'Сегменты высоты',
			'sidebar/geometry/box_geometry/depthseg': 'Сегменты длины',

			'sidebar/geometry/buffer_geometry/attributes': 'Аттрибуты',
			'sidebar/geometry/buffer_geometry/index': 'индекс',
			'sidebar/geometry/buffer_geometry/morphAttributes': 'Аттрибуты Morph',
			'sidebar/geometry/buffer_geometry/morphRelative': 'Morph Relative',

			'sidebar/geometry/capsule_geometry/radius': 'Радиус',
			'sidebar/geometry/capsule_geometry/length': 'Длина',
			'sidebar/geometry/capsule_geometry/capseg': 'Сегменты Cap',
			'sidebar/geometry/capsule_geometry/radialseg': 'Сегменты Radial',

			'sidebar/geometry/circle_geometry/radius': 'Радиус',
			'sidebar/geometry/circle_geometry/segments': 'Сегменты',
			'sidebar/geometry/circle_geometry/thetastart': 'Начало Theta',
			'sidebar/geometry/circle_geometry/thetalength': 'Длина Theta',

			'sidebar/geometry/cylinder_geometry/radiustop': 'Радиус сверху',
			'sidebar/geometry/cylinder_geometry/radiusbottom': 'Радиус снизу',
			'sidebar/geometry/cylinder_geometry/height': 'Высота',
			'sidebar/geometry/cylinder_geometry/radialsegments': 'Сегменты Radial',
			'sidebar/geometry/cylinder_geometry/heightsegments': 'Сегменты высоты',
			'sidebar/geometry/cylinder_geometry/openended': 'Открытый',

			'sidebar/geometry/extrude_geometry/curveSegments': 'Curve Segments',
			'sidebar/geometry/extrude_geometry/steps': 'Steps',
			'sidebar/geometry/extrude_geometry/depth': 'Длина',
			'sidebar/geometry/extrude_geometry/bevelEnabled': 'Bevel',
			'sidebar/geometry/extrude_geometry/bevelThickness': 'Thickness',
			'sidebar/geometry/extrude_geometry/bevelSize': 'Размер',
			'sidebar/geometry/extrude_geometry/bevelOffset': 'Смещение',
			'sidebar/geometry/extrude_geometry/bevelSegments': 'Сегменты',
			'sidebar/geometry/extrude_geometry/shape': 'В фигуру',
			...
			'sidebar/geometry/tetrahedron_geometry/detail': 'Детали',

			'sidebar/geometry/lathe_geometry/segments': 'Сегменты',
			'sidebar/geometry/lathe_geometry/phistart': 'Начало Phi (°)',
			'sidebar/geometry/lathe_geometry/philength': 'Длина Phi (°)',
			...
			'sidebar/geometry/plane_geometry/widthsegments': 'Сегменты ширины',
			'sidebar/geometry/plane_geometry/heightsegments': 'Сегменты высоты',

			'sidebar/geometry/ring_geometry/innerRadius': 'Внутренний радиус',
			'sidebar/geometry/ring_geometry/outerRadius': 'Наружный радиус',
			'sidebar/geometry/ring_geometry/thetaSegments': 'Сегменты Theta',
			'sidebar/geometry/ring_geometry/phiSegments': 'Сегменты Phi',
			'sidebar/geometry/ring_geometry/thetastart': 'Начало Theta',
			'sidebar/geometry/ring_geometry/thetalength': 'Длина Theta',

			'sidebar/geometry/shape_geometry/curveSegments': 'Сегменты Curve',
			'sidebar/geometry/shape_geometry/extrude': 'Extrude',

			'sidebar/geometry/sphere_geometry/radius': 'Радиус',
			'sidebar/geometry/sphere_geometry/widthsegments': 'Сегменты ширины',
			'sidebar/geometry/sphere_geometry/heightsegments': 'Сегменты высоты',
			'sidebar/geometry/sphere_geometry/phistart': 'Начало Phi',
			'sidebar/geometry/sphere_geometry/philength': 'Длина Phi',
			'sidebar/geometry/sphere_geometry/thetastart': 'Начало Theta',
			'sidebar/geometry/sphere_geometry/thetalength': 'Длина Theta',
			...
			'sidebar/material/alphamap': 'Текстура прозрачности',
			'sidebar/material/bumpmap': 'Текстура бампа',
			'sidebar/material/normalmap': 'Текстура нормалей',
			'sidebar/material/clearcoatmap': 'Clearcoat Map',
			'sidebar/material/clearcoatnormalmap': 'Clearcoat Normal Map',
			'sidebar/material/clearcoatroughnessmap': 'Clearcoat Roughness Map',
			'sidebar/material/displacementmap': 'Displace Map',
			...
			'sidebar/material/size': 'Размер',
			'sidebar/material/sizeAttenuation': 'Size Attenuation',
			'sidebar/material/flatShading': 'Плоско',
			'sidebar/material/blending': 'Blending',
			'sidebar/material/opacity': 'Прозрачность',
			'sidebar/material/transparent': 'Прозрачный',
			'sidebar/material/forcesinglepass': 'Force Single Pass',
			'sidebar/material/alphatest': 'Тест прозрачности',
			'sidebar/material/depthtest': 'Тест дальности',
			'sidebar/material/depthwrite': 'Depth Write',
			'sidebar/material/wireframe': 'Wireframe',
			'sidebar/material/userdata': 'Пользовательские переменные',
			'sidebar/material/export': 'Экспортировать в виде JSON',

			'sidebar/script/new': 'Новый',
			'sidebar/script/edit': 'Редактировать',
			'sidebar/script/remove': 'Удалить',

			'sidebar/render': 'Рендеринг',
			'sidebar/project/antialias': 'Сглаженные края',
			'sidebar/project/shadows': 'Тени',
			'sidebar/project/toneMapping': 'Tonemapping',
			'sidebar/project/materials': 'Материалы',
			'sidebar/project/Assign': 'Назначить',

			'sidebar/project/image': 'Изображение',
			'sidebar/project/image/samples': 'Samples',
			'sidebar/project/video': 'Видео',

			'sidebar/project/shading': 'Shading',
			'sidebar/project/resolution': 'Разрешение',
			'sidebar/project/duration': 'Длительность',
			'sidebar/project/render': 'Рендерить!',

			'sidebar/editor': 'Редактор',
			'sidebar/settings/language': 'Язык',

			'sidebar/settings/shortcuts': 'Клавиши',
			'sidebar/settings/shortcuts/translate': 'Переместить',
			'sidebar/settings/shortcuts/rotate': 'Переместить',
			'sidebar/settings/shortcuts/scale': 'Изменить размер',
			'sidebar/settings/shortcuts/undo': 'Отменить',
			'sidebar/settings/shortcuts/focus': 'Фокусировка',

			'sidebar/history': 'Изменения',
			'sidebar/history/clear': 'Очистить',
			'sidebar/history/persistent': 'Сохранять при выходе',

			'toolbar/translate': 'Переместить',
			'toolbar/rotate': 'Переместить',
			'toolbar/scale': 'Изменить размер',
			'toolbar/local': 'Локально',

			'viewport/controls/grid': 'Клетка',
			'viewport/controls/helpers': 'Помощники',

			'viewport/info/object': 'Объект',
			'viewport/info/objects': 'Объекты',
			'viewport/info/vertex': 'Вершина',
			'viewport/info/vertices': 'Вершина',
			'viewport/info/triangle': 'Сторона',
			'viewport/info/triangles': 'Стороны',
			'viewport/info/sample': 'Sample',
			'viewport/info/samples': 'Samples',
			'viewport/info/rendertime': 'Время рендеринга',

			'script/title/vertexShader': 'Шейдер вершины',
			'script/title/fragmentShader': 'Шейдер фрагмента',
			'script/title/programInfo': 'Свойства программы'
